...
# backend/src/utils.py -> .parent (src) -> .parent (backend)
...
def load_raw_data(path=DATA_PATH_RAW):
    # Load using Path objects for cross-OS compatibility (Windows/Linux)
...
def load_processed_data(path=DATA_PATH_PROCESSED):
